...
StatsBase.fit(Histogram, data, nbins=64, closed=:right).weights)

# ╔═╡ 8c5bd8fb-32ab-4ac1-8dfe-dfe299a05569
let
	# data = rand(1:64, 1024)
	hist =  histogram(data, 64, (1, 64))
	UnicodePlots.vertical_histogram(hist, vertical=true, height=10)
end

# ╔═╡ da45dc9d-d3b7-4fe2-a0ce-b9f91a10b1ab
md"""
# Exercise: Linked-List / Queues
"""
...
manifest_format = "2.0"
project_hash = "579c84d4a78da34a4bb362e32b3b7e1c20b0c541"
