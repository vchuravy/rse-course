...
- M.Sc & PhD in Computer Science (Massachussetts Institute of Technology, USA 2017-2024)
- Research Software Engineer / PostDoc (University of Mainz / University of Augsburg)

Working on GPU computing in Julia since 2014 – First Julia version 0.3-dev

I work on the Julia compiler and runtime. My goal is to make HPC and GPU based programming easier and more accessible, I work with science teams to help them maximise their usage of Julia.
"""

# ╔═╡ ea4755b6-192d-4965-b780-b956535ca868
md"""
## What is reasearch software engineering
...
$(Resource("https://www.software.ac.uk/sites/default/files/images/content/BetterSoftwareBetterResearchImage.jpg"))

- Data analysis
  - Classical data science / statistics
  - Visualization
- Data generation
  - Modelling
...
md"""
### Principles of research software engineering

Best practices of research software engineering, how to develop scientific software in an reproducible, collaborative way.
...
!!! note
    The goal is to enable **you**, to build the software you need for your research. 
"""
...
Computers are becoming evermore parallel.
...
Scientific software *often* has the characteristics that it can scale.

1. Strong-scaling: \
    More compute resources will enable a faster time to solution (constant problem size)
2. Weak-scaling: \
    Increasing the problem size and compute resources, provides a better solution in the same time

!!! note
    Writing parallel programs takes more consideration than writing a serial problem, but we must to solve problems efficiently
...
# ╔═╡ 6e13e5fa-6ed8-4769-8fc4-5537f982d953
md"""
### Performance Engineering
"""

# ╔═╡ e897e65c-39e8-4bb1-9ca0-b2adeca2903e
md"""
...
!!! note
    Automatic differentiation is the art of taking derivatives not of mathematical functions, but of computer programs that implement mathematical functions.
    It is a corner-stone of both scientfici computing and machine learning.
"""

# ╔═╡ f4167ac5-e084-46e5-b6ac-0fd89b1b03d2
md"""
## What's Julia? 🟢 🟣 🔴
...
# ╔═╡ ba7a37e3-be92-4564-b6a9-8d765f1359c0
md"""
## Why Julia? 😍
...
# ╔═╡ 00bcd7d9-9ee4-4e9e-ac17-37bec43755a3
md"""
...
# ╔═╡ 37e5fcf8-8a4e-4f02-82e6-7723f34d63d8
...
# ╔═╡ 3772ab80-aa72-43bd-bcc3-350c83f49aec
...
manifest_format = "2.0"
project_hash = "70f859c9fb3f00896387b72e356110b7f6b756f9"
