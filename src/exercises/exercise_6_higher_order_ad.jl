...
# ╔═╡ 2a444d12-1189-4bc7-b16e-f4c689a75f6a
nth_derivative(sin, 1.0, Val(1)) == cos(1.0)

# ╔═╡ 03058c00-5871-480f-b0e0-cab045d44167
...
# ╔═╡ fe1b62dc-0832-4ccb-985e-33564e9bc689
let D = ForwardDiff.derivative
	D(x -> x * D(y -> x + y, 1), 1)
end

# ╔═╡ 4cc7a481-9ca5-4852-8069-d65d8c86f331
