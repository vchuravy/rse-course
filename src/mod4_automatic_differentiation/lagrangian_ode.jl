...
#> section = "2"
#> order = "12.1"
#> title = "Lagrangian Mechanics via AD"
...
$\frac{dL}{dq} - \frac{d}{d\dot{q}} (\frac{dL}{d\dot{q}}) \frac{d\dot{q}}{dt} = 0$
...
Of course this will cost more than actually using a precomputed right-hand side
(which does not require inverting the Hessian for every RHS evaluation), but sometimes
some systems are lightweight enough, yet complicated enough to differentiate by hand,
that just implementing the Lagrangian and forgetting about everything else is a nice bonus.
Generally, writing down the Lagrangian of many physical/mechanical systems is trivial,
while writing down the equations of motion is a huge amount of work to be done by hand
(or with SymPy).
"""
...
manifest_format = "2.0"
project_hash = "875089c71792e63ed3860de5739ddf86fd7484c4"
...
git-tree-sha1 = "f3e7cd82d057fdeacf9c12292ea72481c05a57c2"
